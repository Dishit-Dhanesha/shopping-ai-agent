...
useSeoMeta({
  title: 'AI Assisted E-Commerce',
  description:
    'A high-performance, server-rendered E-commerce app built with Nuxt & AWS',
  ogTitle: 'AI Assisted E-Commerce',
  ogDescription:
    'A high-performance, server-rendered E-commerce app built with Nuxt & AWS',
...
defineOgImageComponent('Nuxt', {
  title: 'AI Assisted E-Commerce',
  description: 'A high-performance, server-rendered E-commerce app built with Nuxt & AWS',
  theme: '#4ADE80',
  headline: '',
  colorMode: 'dark',
})
